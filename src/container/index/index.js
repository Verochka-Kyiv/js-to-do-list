export class Todo {
  ...
  static #list = [] //збираються об'єкти наших задач
  static #count = 0
  ...
  static #block = null // наш блок main
  static #template = null // наш темплейт
  static #input = null // наш "введіть задачу"
  static #button = null // наша кнопка Додати
  ...
  static #render = () => {
    ...
    if (this.#list.length === 0) {
      this.#block.innerText = 'Empty list'
    } else {
